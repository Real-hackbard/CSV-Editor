...
![Last Update](https://github.com/user-attachments/assets/e1d05f21-2a01-4ecf-94f3-b7bdff4d44dd) <img src="https://github.com/user-attachments/assets/ebe0dfe5-b82c-4d1f-8b73-29a839dafc7f" />  
...
* [Virtual desktops](https://en.wikipedia.org/wiki/Virtual_desktop) cannot be spanned by children of the MDI. However, in some cases, this is solvable by initiating another parent window; this is the case in [Opera](https://en.wikipedia.org/wiki/Opera_(web_browser)) and [Chrome](https://en.wikipedia.org/wiki/Google_Chrome), for example, which allows tabs/child windows to be dragged outside of the parent window to start their own parent window. In other cases, each child window is also a parent window, forming a new, "virtual" MDI .
